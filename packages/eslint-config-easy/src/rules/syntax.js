...
module.exports = {
  rules: {
    ...
    // 'object-shorthand': 'off', // fixable; off to not care whether use {x, f(){}}
    // 'prefer-const': 'off', // fixable; off to allow let for un-reassigned vars
    // 'wrap-iife': ['error', 'any'], // fixable
    // strict: 'off', // fixable; off to allow 'use strict' in script file
  },
};
